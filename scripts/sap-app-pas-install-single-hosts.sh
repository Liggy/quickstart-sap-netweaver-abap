...
then
    ...
    ASCS_INI_FILE="/sapmnt/SWPM/S4H1809/ASCS_00_Linux_HDB.params"
    PAS_INI_FILE="/sapmnt/SWPM/S4H1809/PASX_D00_Linux_HDB.params"
    DB_INI_FILE="/sapmnt/SWPM/S4H1809/DB_00_Linux_HDB.params"
...
./sapinst SAPINST_INPUT_PARAMETERS_URL="$ASCS_INI_FILE" SAPINST_EXECUTE_PRODUCT_ID="$ASCS_PRODUCT" SAPINST_USE_HOSTNAME="$SAPPAS_HOSTNAME" SAPINST_SKIP_DIALOGS="true" SAPINST_SLP_MODE="false" SAPINST_START_GUISERVER="false"
...
then
     ...
     ./sapinst SAPINST_INPUT_PARAMETERS_URL="$DB_INI_FILE" SAPINST_EXECUTE_PRODUCT_ID="$DB_PRODUCT" SAPINST_USE_HOSTNAME="$SAPPAS_HOSTNAME"  SAPINST_SKIP_DIALOGS="true" SAPINST_SLP_MODE="false" SAPINST_START_GUISERVER="false"
...
./sapinst SAPINST_INPUT_PARAMETERS_URL="$PAS_INI_FILE" SAPINST_EXECUTE_PRODUCT_ID="$PAS_PRODUCT" SAPINST_USE_HOSTNAME="$SAPPAS_HOSTNAME"  SAPINST_SKIP_DIALOGS="true" SAPINST_SLP_MODE="false" SAPINST_START_GUISERVER="false"
